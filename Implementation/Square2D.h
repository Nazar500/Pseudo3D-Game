...
public:
	Square2D(const Point2D& pos, double size = Settings::SCALE, double h_height = 1., const std::string& texture = Settings::SKIN) : s_size(size), Object2D(pos, vector<Point2D>(4, 0), h_height, false, texture, true) {
